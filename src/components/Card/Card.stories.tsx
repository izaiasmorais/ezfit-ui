import { FlashIcon, Moon02Icon, SquareIcon } from "@hugeicons/core-free-icons";
...
export const Light: Story = {
	render: () => (
		<Card variant="light" className="min-h-[150px] w-72">
			<IconTile icon={SquareIcon} tone="neutral" className="mb-4" />
...
export const Dark: Story = {
	render: () => (
		<Card variant="dark" className="min-h-[150px] w-72">
			<IconTile icon={Moon02Icon} tone="onDark" className="mb-4" />
...
export const Accent: Story = {
	render: () => (
		<Card variant="accent" className="min-h-[150px] w-72">
			<IconTile icon={FlashIcon} tone="onAccent" className="mb-4" />
